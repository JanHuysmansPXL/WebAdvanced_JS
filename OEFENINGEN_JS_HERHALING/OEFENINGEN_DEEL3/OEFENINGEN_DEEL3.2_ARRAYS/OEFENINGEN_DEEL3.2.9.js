...
let dagnaam = ["Maandag", "Dinsdag", "Woensdag", "Donderdag", "Vrijdag", "Zaterdag", "Zondag"]
...
let huidigeDag = dagnaam[dagen.getDay()];
...
for (let dagen = 1; dagen <= aantalDagenPerMaand[huidigeMaand]; dagen++) {
    if (dagen < 10) {
        uitkomst = uitkomst + huidigeDag + " " + 0 + dagen + "/" + huidigeMaand + "/" + huidigJaar + "<br>";
        document.getElementById("datums").innerHTML = uitkomst;
    }
    else {
        uitkomst = uitkomst + huidigeDag + " " + dagen + "/" + huidigeMaand + "/" + huidigJaar + "<br>";
        document.getElementById("datums").innerHTML = uitkomst;
